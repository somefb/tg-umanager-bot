...
const dictionary = [
  ...
  },
  {
    ...
    replacers: [
      ...
      { one: "покос", two: "триммер", oneEng: "trimmer" },
      { one: "мгла", two: "тень", oneEng: "shadow" },
    ],
  },
  {
    keyWords: ["палец", "поцелуй", "призрак"],
    replacers: [
      { one: "русло", two: "приток", oneEng: "influx" },
      { one: "солидарность", two: "помощь", oneEng: "assistance" },
      { one: "зелень", two: "природа", oneEng: "nature" },
      { one: "развилка", two: "перекрёсток", oneEng: "fork" },
      { one: "дорога", two: "путь", oneEng: "way" },
    ],
  },
  {
    keyWords: ["жизнь", "желание", "жаба"],
    replacers: [
      { one: "скупость", two: "жадность", oneEng: "greed" },
      { one: "грязь", two: "жижа", oneEng: "mud" },
      { one: "мука", two: "жернова", oneEng: "millstones" },
      { one: "претензия", two: "жалоба", oneEng: "complaint" },
      { one: "холод", two: "жара", oneEng: "heat" },
    ],
  },
  {
    ...
    replacers: [
      ...
      { one: "ушу", two: "карате", oneEng: "karate" },
      { one: "блокбастер", two: "кино", oneEng: "cinema" },
  ...
  },
  {
    ...
    replacers: [
      ...
      { one: "крючок", two: "леска", oneEng: "fishing line" },
  ...
  },
  {
    ...
    replacers: [
      ...
      { one: "белое", two: "сало", oneEng: "lard" },
      { one: "радио", two: "сарафанное", oneEng: "grapevining" },
      { one: "быки", two: "стадо", oneEng: "herd" },
      { one: "дырявое", two: "сито", oneEng: "sieve" },
    ],
  },
  {
    keyWords: ["апельсин", "ананас", "антилопа"],
    replacers: [
      { one: "качели", two: "аттракцион", oneEng: "attraction" },
      { one: "шутка", two: "анекдот", oneEng: "joke" },
      { one: "обозначение", two: "артикул", oneEng: "set number" },
      { one: "глобус", two: "атлас", oneEng: "atlas" },
      { one: "лук", two: "арбалет", oneEng: "crossbow" },
    ],
  },
];
